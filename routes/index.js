...
routes.video = function(req, res) {
  ...
  var tempID = '56eae22b7cd14f259b8323ea';
...
routes.newComment = function(req, res) {
  var tempID = '56eae22b7cd14f259b8323ea'; //This will be a capture of whatever video it is ObjectId("56eae22b7cd14f259b8323ea")
...
routes.newReply = function(req, res) {
  var tempID = '56eb61681ec202f79c5363c8'; // This will also be a capture of the comment ID, we may want to make mongoose _id a class in Handlebars
